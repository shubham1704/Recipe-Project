package com.example.springmvc.recipeproject.bootstrap;

import com.example.springmvc.recipeproject.domain.Category;
import com.example.springmvc.recipeproject.domain.Difficulty;
...
import com.example.springmvc.recipeproject.repositories.CategoryRepository;
...
//    guacNotes.setRecipe(guacRecipe); Removing this line because we are already adding this into our recipe class
...
//    tacoNotes.setRecipe(tacosRecipe);
    ...
    tacosRecipe.getIngredients().add(new Ingredients("Dried Oregano", new BigDecimal(1), teapoonUom));
    tacosRecipe.getIngredients().add(new Ingredients("Dried Cumin", new BigDecimal(1), teapoonUom));
    tacosRecipe.getIngredients().add(new Ingredients("Sugar", new BigDecimal(1), teapoonUom));
    tacosRecipe.getIngredients().add(new Ingredients("Salt", new BigDecimal(".5"), teapoonUom));
    ...
    tacosRecipe.getIngredients().add(new Ingredients("packed baby arugula", new BigDecimal(3), cupsUom));
    ...
    tacosRecipe.getIngredients().add(new Ingredients("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4), cupsUom));
